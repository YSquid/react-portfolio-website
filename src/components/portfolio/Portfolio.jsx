...
import gdpLife from "../../assets/gdp_life.png"
...
const dataProjects = [
  {
    ...
    description:
      "Analysis of sales data using Power BI and presented in PowerPoint",
    tech: ["Python", "PowerPoint", "Excel"],
  },
  {
    id: "dp-gdp",
    image: gdpLife,
    github: "https://github.com/YSquid/gdp_life",
    title: "GDP & Life Expectancy",
    preview: "https://github.com/YSquid/ecomm-client",
    description:
      "Analysis of relationship between GDP and life expectancy using world bank data",
...
const webProjects = [
  {
    ...
    description:
      "A mock e-commerce store. Features - user registration/authentication, placing orders, and viewing order history.",
    tech: [
      "React",
      "Node.js",
      "Express.js",
...

  {
    ...
    description:
      "A basic functionality Reddit clone built with React and Redux. Utilizes the Reddit JSON API to fetch data from Reddit.",
  ...
  },
  {
    ...
    description:
      "A web app that fetches random quotes with the option to tweet the quote in one click.",
  ...
  return (
    <section id="portfolio">
      ...
      <div className="container portfolio__container data__projects">
        {dataProjects.map(
          ({ id, type, github, image, title, preview, report, description, tech }) => {
            return (
              <article key={id} className="portfolio__item">
                ...
                <p className="project__description">
                  ...
                  {type === "powerBI" ? (
                    <p>
                      Note: PowerBI license required to view Power BI report
                    </p>
                  ) : null}
                </p>
                <ul className="tech">
      ...
      <div className="container portfolio__container web__projects">
        {webProjects.map(
          ({ id, image, title, github, site, description, tech }) => {
            return (
              <article key={id} className="portfolio__item">
                <div className="portfolio__item-img">
